...
//To avoid this, you can use Resource annotations.
...
//In this case, add the @StringRes annotation to your string resource ID property and
//@DrawableRes annotation to your drawable resource ID property.
